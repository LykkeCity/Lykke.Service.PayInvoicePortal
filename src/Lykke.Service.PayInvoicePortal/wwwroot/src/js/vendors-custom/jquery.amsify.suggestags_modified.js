...
(function($) {
    ...
    $.fn.amsifySuggestags = function(options, method) {
        ...
        var settings = $.extend({
            ...
            afterRemove   : {},
            // modified
            invalidClass  : 'amsify-select-tag--error',
            isValidFunc   : {}
        }, options);
        ...
        AmsifySuggestags.prototype = {
            ...
            addTag : function(value) {
              ...
              if (settings.isValidFunc && typeof settings.isValidFunc === 'function' && settings.isValidFunc(value) === false) {
                isInvalidValue = true;
              }
              // #endregion modified
              var html  = '<span class="'+this.classes.tagItem.substring(1) + 
                /* modified */ (isInvalidValue ? ' ' + settings.invalidClass : '') +
                '" data-val="'+value+'">'+value+' '+this.setIcon()+'</span>';
            ...
            removeTag : function(item, animate) {
              ...
              // modified - fixes for afterRemove
